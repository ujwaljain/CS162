...
public class KThread {
	...
	public static void finish() {
		...
		if (currentThread.threadToJoin != null) {
			currentThread.threadToJoin.ready();
		}	
		sleep();
	}
	...
	public void join() {
		...
		if (status != statusFinished) {
			/* Put current thread to sleep and let forked thread wake this up 
			 * when its finished.
			 */
	...
	private TCB tcb;
	private KThread threadToJoin = null;
